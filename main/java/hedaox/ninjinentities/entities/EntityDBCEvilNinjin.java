...
public class EntityDBCEvilNinjin extends EntityDBCEvil {
	...
	public float auraRed = 255.0F;
	public float auraGreen = 0.0F;
	public float auraBlue = 0.0F;
	...
	public EntityDBCEvilNinjin(World par1World) {
		super(par1World);
	}

	public EntityDBCEvilNinjin(World par1World, int _alignment,
	...
	public void onDeath(DamageSource par1DamageSource) {
		...
		if ((entitySource instanceof EntityPlayer)) {
			...
			for (int i = 0; i < listCloseEntities.size(); i++) {
				...
				if ((entity instanceof EntityDBCEvilNinjin)) {
					EntityDBCEvilNinjin entityTrain = (EntityDBCEvilNinjin) entity;
