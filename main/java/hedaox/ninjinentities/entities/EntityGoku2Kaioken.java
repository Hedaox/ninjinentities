...
public class EntityGoku2Kaioken extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGoku2Kaioken(World par1World) {
		super(par1World, 100, MindState.AGGRESSIVE, true, false, 255.0F, 0.0F, 0.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGoku2Kaioken)) {
					EntityGoku2Kaioken var7 = (EntityGoku2Kaioken) var6;
