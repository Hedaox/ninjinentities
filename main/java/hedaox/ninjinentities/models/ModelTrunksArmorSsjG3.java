...
public class ModelTrunksArmorSsjG3 extends ModelBase {
	...
	public ModelTrunksArmorSsjG3(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		Hair10.cubeList.add(new ModelBox(Hair10, 42, 2, -4.6882F, -5.1308F, -0.0337F, 3, 7, 3, 0.0F));
		...
		Hair11.cubeList.add(new ModelBox(Hair11, 42, 2, -4.6882F, -5.1308F, -0.0337F, 3, 7, 3, 0.0F));
		...
		Hair12.cubeList.add(new ModelBox(Hair12, 42, 2, 1.6882F, -5.1308F, -0.0337F, 3, 7, 3, 0.0F));
		...
		Hair13.cubeList.add(new ModelBox(Hair13, 42, 2, 0.6882F, -5.1308F, -0.0337F, 4, 7, 3, 0.0F));
		...
		Hair14.cubeList.add(new ModelBox(Hair14, 42, 2, -4.6882F, -5.1308F, -0.0337F, 4, 7, 3, 0.0F));

		Strand1 = new ModelRenderer(this);
		Strand1.setRotationPoint(-6.0F, -6.0F, -2.9F);
		setRotationAngle(Strand1, -0.3491F, 0.0F, 0.7854F);
		Head.addChild(Strand1);
		Strand1.cubeList.add(new ModelBox(Strand1, 38, 2, 1.6436F, -4.6388F, -3.0979F, 1, 8, 1, 0.0F));

		Strand2 = new ModelRenderer(this);
		Strand2.setRotationPoint(6.0F, -6.0F, -2.9F);
		setRotationAngle(Strand2, -0.3491F, 0.0F, -0.7854F);
		Head.addChild(Strand2);
		Strand2.cubeList.add(new ModelBox(Strand2, 38, 2, -2.6436F, -4.6388F, -3.0979F, 1, 8, 1, 0.0F));
		...
		LArm.setRotationPoint(-3.2F, -3.4F, 0.2F);
		LArm.mirror = true;
		Body.addChild(LArm);
		LArm.cubeList.add(new ModelBox(LArm, 40, 16, 7.0F, -2.0F, -2.0F, 5, 12, 4, 0.0F));
