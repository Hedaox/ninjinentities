...
public class EntityGokuSuper extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGokuSuper(World par1World) {
		super(par1World, 100, MindState.NEUTRAL, true, true);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/gokuSuper.png";
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGokuSuper)) {
					EntityGokuSuper var7 = (EntityGokuSuper) var6;
