...
public class EntityGotenksSsj3 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGotenksSsj3(World par1World) {
		super(par1World, 85, MindState.NEUTRAL, true, true, 255.0F, 217.0F, 25.0F);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/gotrunksSsj3.png";
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGotenksSsj3)) {
					EntityGotenksSsj3 var7 = (EntityGotenksSsj3) var6;
