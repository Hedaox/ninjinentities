...
public class EntityChiaotzu2 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityChiaotzu2(World par1World) {
		super(par1World, 80, MindState.NEUTRAL, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityChiaotzu2)) {
					EntityChiaotzu2 var7 = (EntityChiaotzu2) var6;
