...
public class ModelBandit1 extends ModelBase {
	...
	public ModelBandit1(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		Hair1.setRotationPoint(-2.5F, 0.0F, 3.0F);
		setRotationAngle(Hair1, 0.0F, -1.5708F, 0.0F);
		Head.addChild(Hair1);
		Hair1.cubeList.add(new ModelBox(Hair1, 27, 0, -6.0F, -10.0F, -3.0F, 6, 3, 1, 0.0F));
		...
		Sword.setRotationPoint(-2.0F, 9.0F, -2.0F);
		setRotationAngle(Sword, 1.2217F, 0.0F, 0.0F);
		RArm.addChild(Sword);
		Sword.cubeList.add(new ModelBox(Sword, 59, 16, 0.0F, -13.0F, 0.0F, 0, 13, 2, 0.0F));
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		GL11.glPushMatrix();
		this.scale = 1.1F;
		GL11.glScalef(this.scale*1.2F, this.scale, this.scale);
