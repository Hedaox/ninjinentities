...
public class ModelHoi extends ModelBase {
	...
	public ModelHoi(float _scaleX, float _scaleY, float _scaleZ) {
		...
		Body.addChild(RArm);
		RArm.cubeList.add(new ModelBox(RArm, 0, 49, -2.0F, -0.005F, -2.0F, 3, 11, 4, 0.0F));

		LArm = new ModelRenderer(this);
		LArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		Body.addChild(LArm);
		LArm.cubeList.add(new ModelBox(LArm, 24, 43, -1.0998F, -0.005F, -2.0F, 3, 11, 4, 0.0F));

		RLeg = new ModelRenderer(this);
		RLeg.setRotationPoint(-1.9F, 12.0F, 0.1F);
		Body.addChild(RLeg);
		RLeg.cubeList.add(new ModelBox(RLeg, 32, 0, -2.0F, 1.0F, -2.0F, 4, 11, 4, 0.0F));

		LLeg = new ModelRenderer(this);
		LLeg.setRotationPoint(1.9F, 12.0F, 0.1F);
		Body.addChild(LLeg);
		LLeg.cubeList.add(new ModelBox(LLeg, 40, 42, -2.0F, 1.0F, -2.0F, 4, 11, 4, 0.0F));
	}
