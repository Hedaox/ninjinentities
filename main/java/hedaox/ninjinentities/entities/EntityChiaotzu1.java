...
public class EntityChiaotzu1 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityChiaotzu1(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, false, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityChiaotzu1)) {
					EntityChiaotzu1 var7 = (EntityChiaotzu1) var6;
