...
public class EntityVegeta0 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegeta0(World par1World) {
		super(par1World, 40, MindState.NEUTRAL, false, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegeta0)) {
					EntityVegeta0 var7 = (EntityVegeta0) var6;
