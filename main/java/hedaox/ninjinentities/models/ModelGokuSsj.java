...
public class ModelGokuSsj extends ModelBase {
	...
	public ModelGokuSsj(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		Head.addChild(Hair1);
		Hair1.cubeList.add(new ModelBox(Hair1, 42, 2, -1.5133F, -5.474F, -2.0714F, 4, 8, 4, 0.0F));
