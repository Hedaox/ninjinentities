...
public class EntityKeflaSsj extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityKeflaSsj(World par1World) {
		super(par1World, 95, MindState.NEUTRAL, false, true, 162.0F,255.0F,0.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityKeflaSsj)) {
					EntityKeflaSsj var7 = (EntityKeflaSsj) var6;
