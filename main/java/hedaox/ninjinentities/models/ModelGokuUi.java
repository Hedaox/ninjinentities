...
public class ModelGokuUi extends ModelBase {
	...
	public ModelGokuUi(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		setRotationAngle(Hair2, 0.0F, 0.0F, -0.4363F);
		Head.addChild(Hair2);
		Hair2.cubeList.add(new ModelBox(Hair2, 45, 2, -0.9397F, -1.658F, -3.0F, 3, 5, 3, 0.0F));

		Hair3 = new ModelRenderer(this);
		Hair3.setRotationPoint(1.0F, -8.0F, 0.0F);
		setRotationAngle(Hair3, 0.0F, 0.0F, 0.4363F);
		Head.addChild(Hair3);
		...
		setRotationAngle(Hair7, -0.3491F, 0.0F, 0.6109F);
		Head.addChild(Hair7);
