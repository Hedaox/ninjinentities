...
public class EntityBrolyZ2Ssj extends EntityDBCNinjin {
	...
	public EntityBrolyZ2Ssj(World par1World) {
		super(par1World, 15, MindState.AGGRESSIVE, false, true, new byte[]{1, 3, 5, 6}, new byte[]{6, 6, 6, 6}, 162.0F,255.0F,0.0F);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/brolyZ2Ssj.png";
	}
