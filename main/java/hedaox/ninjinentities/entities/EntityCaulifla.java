...
public class EntityCaulifla extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityCaulifla(World par1World) {
		super(par1World, 95, MindState.NEUTRAL, false, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityCaulifla)) {
					EntityCaulifla var7 = (EntityCaulifla) var6;
