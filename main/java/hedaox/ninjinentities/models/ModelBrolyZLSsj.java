...
public class ModelBrolyZLSsj extends ModelBase {
	...
	public ModelBrolyZLSsj(float _scaleX, float _scaleY, float _scaleZ) {
		...
		setRotationAngle(Hair1, -0.2618F, -0.0001F, -0.9599F);
		Head.addChild(Hair1);
		Hair1.cubeList.add(new ModelBox(Hair1, 45, 2, 0.0603F, -2.658F, -3.0F, 3, 6, 2, 0.0F));
		...
		Hair4.setRotationPoint(3.0F, -8.0F, 0.0F);
		setRotationAngle(Hair4, -0.2618F, 0.0001F, 0.9599F);
		Head.addChild(Hair4);
		Hair4.cubeList.add(new ModelBox(Hair4, 45, 2, -3.0603F, -2.658F, -3.0F, 3, 6, 2, 0.0F));

		Hair5 = new ModelRenderer(this);
		Hair5.setRotationPoint(-2.0F, -7.0F, 1.0F);
		setRotationAngle(Hair5, 2.1816F, 0.4364F, -1.9199F);
		Head.addChild(Hair5);
		Hair5.cubeList.add(new ModelBox(Hair5, 45, 2, 0.1736F, -2.8054F, -2.4469F, 3, 7, 3, 0.0F));

		Hair6 = new ModelRenderer(this);
		Hair6.setRotationPoint(2.0F, -7.0F, 1.0F);
		setRotationAngle(Hair6, 2.0071F, -0.3491F, 2.0072F);
		Head.addChild(Hair6);
		...
		setRotationAngle(Hair9, 2.7925F, 0.0873F, 1.9199F);
		Head.addChild(Hair9);
		Hair9.cubeList.add(new ModelBox(Hair9, 45, 2, 0.3618F, -3.6765F, -2.7815F, 3, 7, 3, 0.0F));

		Hair10 = new ModelRenderer(this);
		Hair10.setRotationPoint(-5.0F, -8.0F, 2.0F);
		setRotationAngle(Hair10, 2.7925F, -0.0873F, -1.9199F);
		...
		setRotationAngle(Hair11, -1.2218F, -0.5236F, 0.0F);
		...
		Hair12.setRotationPoint(3.0F, -5.0F, 1.0F);
		setRotationAngle(Hair12, -1.2218F, 0.5236F, 0.0F);
