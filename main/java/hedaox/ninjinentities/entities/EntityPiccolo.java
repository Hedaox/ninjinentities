...
public class EntityPiccolo extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityPiccolo(World par1World) {
		super(par1World, 75, MindState.NEUTRAL, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityPiccolo)) {
					EntityPiccolo var7 = (EntityPiccolo) var6;
