...
public class EntityVegetaSsjg extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaSsjg(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, true,255.0F, 50.0F, 50.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaSsjg)) {
					EntityVegetaSsjg var7 = (EntityVegetaSsjg) var6;
