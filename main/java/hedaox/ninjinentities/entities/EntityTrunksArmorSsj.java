...
public class EntityTrunksArmorSsj extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityTrunksArmorSsj(World par1World) {
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityTrunksArmorSsj)) {
					EntityTrunksArmorSsj var7 = (EntityTrunksArmorSsj) var6;
