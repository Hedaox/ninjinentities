...
public class EntityTrunksArmorSsjG3 extends EntityDBCGoodNinjin {
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityTrunksArmorSsjG3)) {
					EntityTrunksArmorSsjG3 var7 = (EntityTrunksArmorSsjG3) var6;
