...
public class ModelZarbon extends ModelBase {
	...
	public ModelZarbon(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		Head.addChild(Hair3);
		Hair3.cubeList.add(new ModelBox(Hair3, 42, 2, -0.4867F, -4.474F, -2.0714F, 2, 7, 3, 0.0F));
		...
		Head.addChild(Hair7);
		Hair7.cubeList.add(new ModelBox(Hair7, 46, 6, -0.4867F, -4.474F, -2.0714F, 3, 6, 2, 0.0F));

		Hair8 = new ModelRenderer(this);
		Hair8.setRotationPoint(-2.8F, -9.0F, 2.9F);
		setRotationAngle(Hair8, -0.611F, 0.5236F, -3.0543F);
		Head.addChild(Hair8);
		Hair8.cubeList.add(new ModelBox(Hair8, 44, 6, -2.5133F, -4.474F, -2.0714F, 3, 6, 2, 0.0F));

		Hair9 = new ModelRenderer(this);
		Hair9.setRotationPoint(2.6F, -5.0F, -0.6F);
		Head.addChild(Hair9);
		Hair9.cubeList.add(new ModelBox(Hair9, 36, 2, -4.0133F, -5.674F, -3.0714F, 3, 3, 7, 0.0F));
		...
		Hair10.cubeList.add(new ModelBox(Hair10, 40, 2, -4.0133F, -4.674F, 3.9286F, 2, 2, 10, 0.0F));
