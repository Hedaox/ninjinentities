...
public class ModelGotenksSsj3 extends ModelBase {
	...
	public ModelGotenksSsj3(float _scale) {
		...
		Belt1.setRotationPoint(-0.8F, -1.6F, -2.2F);
		setRotationAngle(Belt1, -0.0698F, 0.0873F, 0.0F);
		RLeg.addChild(Belt1);
		Belt1.cubeList.add(new ModelBox(Belt1, 56, 20, -1.2857F, -1.145F, -0.1004F, 2, 8, 0, 0.0F));
