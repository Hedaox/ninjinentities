...
public class EntityVegetaSuperSsjb extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaSuperSsjb(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, true,50.0F, 255.0F, 255.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaSuperSsjb)) {
					EntityVegetaSuperSsjb var7 = (EntityVegetaSuperSsjb) var6;
