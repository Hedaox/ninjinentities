...
public class EntityKaleSsj extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityKaleSsj(World par1World) {
		super(par1World, 95, MindState.NEUTRAL, false, false, 162.0F,255.0F,0.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityKaleSsj)) {
					EntityKaleSsj var7 = (EntityKaleSsj) var6;
