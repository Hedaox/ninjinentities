...
public class ModelGohanKid1 extends ModelBase {
	...
	public ModelGohanKid1(float _scale) {
		...
		Head.addChild(Hair1);
		Hair1.cubeList.add(new ModelBox(Hair1, 42, 2, -0.5133F, -2.474F, -2.0714F, 3, 5, 3, 0.0F));

		Hair2 = new ModelRenderer(this);
		Hair2.setRotationPoint(-3.0F, -10.0F, 0.0F);
		setRotationAngle(Hair2, 0.0F, 0.0F, -0.6981F);
		Head.addChild(Hair2);
		Hair2.cubeList.add(new ModelBox(Hair2, 45, 2, -1.9397F, -0.658F, -3.0F, 3, 4, 3, 0.0F));
		...
		Head.addChild(Hair5);
		Hair5.cubeList.add(new ModelBox(Hair5, 45, 2, -0.0028F, -1.971F, -3.2188F, 3, 4, 3, 0.0F));
