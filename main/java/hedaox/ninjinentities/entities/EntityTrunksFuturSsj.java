...
public class EntityTrunksFuturSsj extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityTrunksFuturSsj(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/trunksFuturSsj.png";
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityTrunksFuturSsj)) {
					EntityTrunksFuturSsj var7 = (EntityTrunksFuturSsj) var6;
