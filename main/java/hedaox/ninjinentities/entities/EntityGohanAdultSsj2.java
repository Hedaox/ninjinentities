...
public class EntityGohanAdultSsj2 extends EntityDBCGoodNinjin {
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGohanAdultSsj2)) {
					EntityGohanAdultSsj2 var7 = (EntityGohanAdultSsj2) var6;
