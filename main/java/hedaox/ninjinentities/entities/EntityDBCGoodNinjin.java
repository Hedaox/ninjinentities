...
public class EntityDBCGoodNinjin extends EntityDBCGood {
	...
	public EntityDBCGoodNinjin(World par1World) {
		super(par1World);
	}

	public EntityDBCGoodNinjin(World par1World, int _alignment,
	...
	public void onDeath(DamageSource par1DamageSource) {
		...
		if ((entitySource instanceof EntityPlayer)) {
			...
			for (int i = 0; i < listCloseEntities.size(); i++) {
				...
				if ((entity instanceof EntityDBCGoodNinjin)) {
					EntityDBCGoodNinjin entityTrain = (EntityDBCGoodNinjin) entity;
