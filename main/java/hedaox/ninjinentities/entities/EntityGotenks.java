...
public class EntityGotenks extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGotenks(World par1World) {
		super(par1World, 85, MindState.NEUTRAL, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGotenks)) {
					EntityGotenks var7 = (EntityGotenks) var6;
