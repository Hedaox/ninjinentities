...
public class EntityGokuUI extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGokuUI(World par1World) {
		super(par1World, 100, MindState.NEUTRAL, true, true, 225.0F, 225.0F, 225.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGokuUI)) {
					EntityGokuUI var7 = (EntityGokuUI) var6;
