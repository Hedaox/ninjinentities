...
public class ModelSlugOld extends ModelBase {
	...
	public ModelSlugOld(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bodyChild_6.cubeList.add(new ModelBox(bodyChild_6, 0, 0, -7.0F, 1.0F, 2.0F, 14, 20, 0, 0.0F));
		...
		rightarmshoulder.cubeList.add(new ModelBox(rightarmshoulder, 28, 0, -6.0F, -3.0F, -3.0F, 7, 4, 6, 0.0F));
		...
		leftarmshoulder.cubeList.add(new ModelBox(leftarmshoulder, 18, 46, -1.0F, -3.0F, -3.0F, 7, 4, 6, 0.0F));
