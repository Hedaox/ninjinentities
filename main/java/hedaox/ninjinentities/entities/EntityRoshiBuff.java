...
public class EntityRoshiBuff extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;
	private int angerLevel = 0;

	public EntityRoshiBuff(World par1World) {
		super(par1World, 80, MindState.AGGRESSIVE, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityRoshiBuff)) {
					EntityRoshiBuff var7 = (EntityRoshiBuff) var6;
