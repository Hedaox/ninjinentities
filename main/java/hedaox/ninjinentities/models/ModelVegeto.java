...
public class ModelVegeto extends ModelBase {
	...
	private final ModelRenderer LEarring2;
	...
	public ModelVegeto(float _scale) {
		...
		LEarring.setRotationPoint(-0.3F, 0.0F, 0.0F);
		setRotationAngle(LEarring, 0.0F, 0.4363F, 0.0F);
		Head.addChild(LEarring);
		LEarring.cubeList.add(new ModelBox(LEarring, 58, 20, 5.0F, -3.0F, 0.0F, 0, 2, 1, 0.0F));

		LEarring2 = new ModelRenderer(this);
		LEarring2.setRotationPoint(0.3F, 0.0F, 0.0F);
		setRotationAngle(LEarring2, 0.0F, -0.4363F, 0.0F);
		LEarring2.mirror = true;
		Head.addChild(LEarring2);
		LEarring2.cubeList.add(new ModelBox(LEarring2, 58, 20, -5.0F, -3.0F, 0.0F, 0, 2, 1, 0.0F));
		...
		Strand1.setRotationPoint(-4.8F, -8.0F, -2.0F);
		setRotationAngle(Strand1, -0.3491F, 0.0F, 0.5236F);
