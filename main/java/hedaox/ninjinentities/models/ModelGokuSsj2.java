...
public class ModelGokuSsj2 extends ModelBase {
	...
	public ModelGokuSsj2(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		setRotationAngle(Hair1, -0.0873F, 0.0F, 0.6109F);
		Head.addChild(Hair1);
		Hair1.cubeList.add(new ModelBox(Hair1, 42, 2, -1.5133F, -6.474F, -2.0714F, 4, 9, 4, 0.0F));
		...
		setRotationAngle(Strand1, -0.3491F, 0.0F, 0.6109F);
		Head.addChild(Strand1);
		Strand1.cubeList.add(new ModelBox(Strand1, 38, 2, 2.9972F, -2.971F, -3.2188F, 2, 5, 2, 0.0F));
