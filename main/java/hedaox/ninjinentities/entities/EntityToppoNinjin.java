...
public class EntityToppoNinjin extends EntityDBCNinjin {

	public EntityToppoNinjin(World par1World) {
		super(par1World, 80, MindState.NEUTRAL, false, true, new byte[]{1, 3, 6}, new byte[]{4, 4, 4});
