...
public class ModelTurles1 extends ModelBase {
	...
	public ModelTurles1(float _scaleX, float _scaleY, float _scaleZ) {
		...
		Detector.cubeList.add(new ModelBox(Detector, 67, 18, 4.0F, -5.0F, -2.0F, 1, 3, 3, 0.0F));
		Detector.cubeList.add(new ModelBox(Detector, 68, 21, 4.0F, -4.0F, -4.25F, 1, 1, 2, 0.0F));
		...
		screen.cubeList.add(new ModelBox(screen, 65, 26, 0.0F, -5.0F, -5.0F, 4, 3, 0, 0.0F));
		...
		Body.addChild(Cape);
		Cape.cubeList.add(new ModelBox(Cape, 50, 32, -7.0F, 0.0123F, 2.1564F, 14, 20, 0, 0.0F));
