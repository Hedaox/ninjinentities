...
public class EntityGohanKid3 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGohanKid3(World par1World) {
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGohanKid3)) {
					EntityGohanKid3 var7 = (EntityGohanKid3) var6;
