...
public class ModelFreeza5Damaged extends ModelBase {
	...
	public ModelFreeza5Damaged(float _scaleX, float _scaleY, float _scaleZ) {
		...
		Body.cubeList.add(new ModelBox(Body, 64, 0, -4.0F, 0.0F, -2.0F, 8, 5, 4, 0.0F));
		...
		Body.addChild(Tail2);
		Tail2.cubeList.add(new ModelBox(Tail2, 32, 48, -2.0F, 15.0F, 2.0F, 4, 4, 7, 0.0F));

		Chest = new ModelRenderer(this);
		Chest.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(Chest, -0.1745F, 0.0F, 0.0F);
		Body.addChild(Chest);
		Chest.cubeList.add(new ModelBox(Chest, 64, 12, -3.5F, 1.0F, -1.9333F, 7, 4, 1, 0.0F));
		...
		Body.addChild(LArm);
		LArm.mirror = true;
		LArm.cubeList.add(new ModelBox(LArm, 64, 48, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));
