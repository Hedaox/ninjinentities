...
public class EntityVegetaSuper extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaSuper(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, true);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaSuper)) {
					EntityVegetaSuper var7 = (EntityVegetaSuper) var6;
