...
public class EntityVegetaOozaru extends EntityDBCNeutNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaOozaru(World par1World) {
		super(par1World, 40, MindState.AGGRESSIVE, false, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaOozaru)) {
					EntityVegetaOozaru var7 = (EntityVegetaOozaru) var6;
