...
public class EntityVegeta2Ssj2 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegeta2Ssj2(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, false, 255.0F, 217.0F, 25.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegeta2Ssj2)) {
					EntityVegeta2Ssj2 var7 = (EntityVegeta2Ssj2) var6;
