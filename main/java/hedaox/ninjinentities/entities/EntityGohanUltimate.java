...
public class EntityGohanUltimate extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGohanUltimate(World par1World) {
		super(par1World, 100, MindState.NEUTRAL, true, true, 125.0F, 125.0F, 125.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGohanUltimate)) {
					EntityGohanUltimate var7 = (EntityGohanUltimate) var6;
