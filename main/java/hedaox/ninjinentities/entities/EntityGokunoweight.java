...
public class EntityGokunoweight extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityGokunoweight(World par1World) {
		super(par1World, 100, MindState.AGGRESSIVE, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityGokunoweight)) {
					EntityGokunoweight var7 = (EntityGokunoweight) var6;
