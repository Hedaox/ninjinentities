...
public class ModelTrunks extends ModelBase {
	...
	public ModelTrunks(float _scale) {
		textureWidth = 64;
		textureHeight = 32;
		...
		Head.addChild(Hair3);
		Hair3.cubeList.add(new ModelBox(Hair3, 42, 2, -0.4867F, -4.474F, -2.0714F, 3, 6, 3, 0.0F));

		Hair4 = new ModelRenderer(this);
		Hair4.setRotationPoint(-3.4F, -9.0F, -1.6F);
		setRotationAngle(Hair4, 0.5236F, 0.3491F, -2.1816F);
		Head.addChild(Hair4);
		Hair4.cubeList.add(new ModelBox(Hair4, 42, 2, -2.5133F, -4.474F, -2.0714F, 3, 6, 3, 0.0F));

		Hair5 = new ModelRenderer(this);
		Hair5.setRotationPoint(-2.8F, -9.0F, 2.9F);
		setRotationAngle(Hair5, -0.0873F, 0.0F, -2.1816F);
		Head.addChild(Hair5);
		Hair5.cubeList.add(new ModelBox(Hair5, 42, 2, -2.5133F, -4.474F, -2.0714F, 3, 6, 3, 0.0F));

		Hair6 = new ModelRenderer(this);
		Hair6.setRotationPoint(2.8F, -9.0F, 2.9F);
		setRotationAngle(Hair6, -0.0873F, 0.0F, 2.1816F);
		Head.addChild(Hair6);
		Hair6.cubeList.add(new ModelBox(Hair6, 42, 2, -0.4867F, -4.474F, -2.0714F, 3, 6, 3, 0.0F));

		Hair7 = new ModelRenderer(this);
		Hair7.setRotationPoint(2.8F, -9.0F, 2.9F);
		setRotationAngle(Hair7, -0.7855F, -0.6981F, 3.0543F);
		Head.addChild(Hair7);
		...
		setRotationAngle(Hair8, -0.7855F, 0.6981F, -3.0543F);
		Head.addChild(Hair8);
