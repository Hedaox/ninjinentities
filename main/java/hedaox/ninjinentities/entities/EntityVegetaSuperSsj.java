...
public class EntityVegetaSuperSsj extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaSuperSsj(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, true, 255.0F, 217.0F, 25.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaSuperSsj)) {
					EntityVegetaSuperSsj var7 = (EntityVegetaSuperSsj) var6;
