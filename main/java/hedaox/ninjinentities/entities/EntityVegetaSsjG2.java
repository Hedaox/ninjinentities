...
public class EntityVegetaSsjG2 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetaSsjG2(World par1World) {
		super(par1World, 70, MindState.AGGRESSIVE, true, true, 255.0F, 217.0F, 25.0F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegetaSsjG2)) {
					EntityVegetaSsjG2 var7 = (EntityVegetaSsjG2) var6;
