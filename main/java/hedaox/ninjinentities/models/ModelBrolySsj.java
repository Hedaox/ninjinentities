...
public class ModelBrolySsj extends ModelBase {
	...
	public ModelBrolySsj(float _scale) {
		textureWidth = 128;
		textureHeight = 64;
		...
		Hair2.setRotationPoint(-4.0F, -11.0F, 0.0F);
		setRotationAngle(Hair2, -0.7854F, 0.0F, 1.6581F);
		Head.addChild(Hair2);
		Hair2.cubeList.add(new ModelBox(Hair2, 45, 2, 1.0603F, -3.658F, -3.0F, 2, 7, 3, 0.0F));

		Hair3 = new ModelRenderer(this);
		Hair3.setRotationPoint(4.0F, -11.0F, -1.0F);
		setRotationAngle(Hair3, -0.6981F, 0.2618F, -1.9199F);
		Head.addChild(Hair3);
		Hair3.cubeList.add(new ModelBox(Hair3, 45, 2, -3.0603F, -3.658F, -3.0F, 2, 7, 3, 0.0F));

		Hair4 = new ModelRenderer(this);
		Hair4.setRotationPoint(3.0F, -7.0F, 2.0F);
		setRotationAngle(Hair4, -0.5236F, 0.0873F, 0.2618F);
		Head.addChild(Hair4);
		Hair4.cubeList.add(new ModelBox(Hair4, 40, 2, -5.82F, -7.1704F, -3.4271F, 4, 7, 4, 0.0F));
		...
		setRotationAngle(Hair6, 2.7925F, -0.0873F, 1.4836F);
		Head.addChild(Hair6);
		...
		Head.addChild(Hair8);
		Hair8.cubeList.add(new ModelBox(Hair8, 45, 2, -4.8099F, -4.4417F, -5.0982F, 3, 8, 3, 0.0F));

		Hair9 = new ModelRenderer(this);
		Hair9.setRotationPoint(4.0F, -7.0F, 2.0F);
		setRotationAngle(Hair9, 2.7925F, 0.0873F, 1.2217F);
		Head.addChild(Hair9);
		Hair9.cubeList.add(new ModelBox(Hair9, 45, 2, 0.3618F, -3.6765F, -2.7815F, 3, 7, 3, 0.0F));

		Hair10 = new ModelRenderer(this);
		Hair10.setRotationPoint(-4.0F, -7.0F, 2.0F);
		setRotationAngle(Hair10, 2.7925F, -0.0873F, -1.2217F);
		...
		Hair11.cubeList.add(new ModelBox(Hair11, 42, 2, 0.9972F, -5.6289F, -4.1585F, 3, 8, 3, 0.0F));
		...
		Hair12.cubeList.add(new ModelBox(Hair12, 43, 2, -3.9972F, -5.6289F, -4.1585F, 3, 8, 3, 0.0F));
		...
		Hair13.cubeList.add(new ModelBox(Hair13, 44, 2, 1.9972F, -4.6289F, -4.1585F, 2, 7, 3, 0.0F));
		...
		Hair14.cubeList.add(new ModelBox(Hair14, 43, 2, -3.9972F, -4.6289F, -4.1585F, 2, 7, 3, 0.0F));
		...
		Hair15.cubeList.add(new ModelBox(Hair15, 42, 2, -4.9972F, -6.6289F, -4.1585F, 3, 9, 3, 0.0F));
		...
		Hair16.cubeList.add(new ModelBox(Hair16, 44, 2, -4.9972F, -6.6289F, -4.1585F, 3, 7, 3, 0.0F));
		...
		Hair17.cubeList.add(new ModelBox(Hair17, 44, 2, 1.9972F, -6.6289F, -4.1585F, 3, 7, 3, 0.0F));
		...
		Strand1.cubeList.add(new ModelBox(Strand1, 42, 2, 0.583F, -0.6421F, -2.7351F, 2, 4, 2, 0.0F));
		...
		Strand2.cubeList.add(new ModelBox(Strand2, 42, 2, 1.9972F, -1.6421F, -2.7351F, 2, 5, 2, 0.0F));
		...
		Strand3.cubeList.add(new ModelBox(Strand3, 42, 2, 1.9972F, -0.6421F, -2.7351F, 2, 4, 2, 0.0F));
