...
public class EntityKrillinKid2 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityKrillinKid2(World par1World) {
		super(par1World, 95, MindState.NEUTRAL, true, false);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityKrillinKid2)) {
					EntityKrillinKid2 var7 = (EntityKrillinKid2) var6;
