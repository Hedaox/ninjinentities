...
public class EntityNappaDamaged extends EntityDBCNinjin {

	public int randomSoundDelay = 0;

	public EntityNappaDamaged(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/nappaDamaged.png";
	}
