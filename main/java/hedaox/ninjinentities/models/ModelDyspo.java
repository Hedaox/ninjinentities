...
public class ModelDyspo extends ModelBase {
	...
	public ModelDyspo(float _scaleX, float _scaleY, float _scaleZ) {
		...
		Head.addChild(Snout);
		Snout.cubeList.add(new ModelBox(Snout, 50, 2, -3.0F, 2.0F, -4.0F, 4, 3, 2, 0.0F));

		REar = new ModelRenderer(this);
		REar.setRotationPoint(-2.0F, -6.0F, -1.0F);
		setRotationAngle(REar, -0.2618F, 0.0F, -0.2618F);
		Head.addChild(REar);
		REar.cubeList.add(new ModelBox(REar, 32, 0, -2.0F, -8.0F, 0.0F, 4, 8, 0, 0.0F));

		LEar = new ModelRenderer(this);
		LEar.setRotationPoint(2.0F, -6.0F, -1.0F);
		LEar.mirror = true;
		setRotationAngle(LEar, -0.2618F, 0.0F, 0.2618F);
		Head.addChild(LEar);
		LEar.cubeList.add(new ModelBox(LEar, 32, 0, -2.0F, -8.0F, -1.0F, 4, 8, 0, 0.0F));
