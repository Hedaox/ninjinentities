...
public class EntityVegeta2 extends EntityDBCGoodNinjin {

	public int randomSoundDelay = 0;

	public EntityVegeta2(World par1World) {
		super(par1World, 70, MindState.NEUTRAL, true, false);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/vegeta2.png";
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if ((var3 instanceof EntityPlayer)) {
			...
			for (int var5 = 0; var5 < var4.size(); var5++) {
				...
				if ((var6 instanceof EntityVegeta2)) {
					EntityVegeta2 var7 = (EntityVegeta2) var6;
