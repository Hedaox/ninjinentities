...
public class ModelVegetaArmorDamaged extends ModelBase {
	...
	public ModelVegetaArmorDamaged(float _scaleX, float _scaleY, float _scaleZ) {
		...
		Hair10.cubeList.add(new ModelBox(Hair10, 40, 6, 0.9972F, -4.6289F, -4.1585F, 3, 7, 3, 0.0F));
		...
		Hair11.cubeList.add(new ModelBox(Hair11, 39, 6, 0.9972F, -4.6289F, -4.1585F, 3, 7, 3, 0.0F));

		Strand2 = new ModelRenderer(this);
		Strand2.setRotationPoint(-3.0F, -7.0F, -1.0F);
		setRotationAngle(Strand2, -0.2618F, 0.0F, 0.0F);
		Head.addChild(Strand2);
		Strand2.cubeList.add(new ModelBox(Strand2, 41, 8, 1.9972F, -1.971F, -3.2188F, 2, 4, 2, 0.0F));
		...
		LArm.mirror = false;
		LArm.cubeList.add(new ModelBox(LArm, 0, 0, 12.02F, -2.0F, -1.0F, 0, 2, 2, 0.0F));
		...
		LLeg.mirror = false;
		LLeg.cubeList.add(new ModelBox(LLeg, 0, 0, 3.0F, 2.0F, -2.02F, 2, 2, 0, 0.0F));
	}
